...
#> # i 206 more variables: activism2 <dbl>, ad_exp <dbl>, age_ipo <dbl>,
...
#> # i 791 more rows
#> # i 120 more variables: IPFPNSS <dbl>, IPFINAL <dbl>, IPCONGD <dbl>,
...
#> # i 9,350 more rows
#> # i 4 more variables: depth0_bid <dbl>, depth5_ask <dbl>, depth5_bid <dbl>,
#> #   spread <dbl>
```
...
#> # i 43,319 more rows
#> # i 6 more variables: listing_age <int>, mktcap <dbl>, mktcap_lag <dbl>,
...
#> # i 11,980 more rows
#> # i 16 more variables: itcb <dbl>, pstkrv <dbl>, pstkl <dbl>, pstk <dbl>,
...
#>  5  54594 001004 1972-04-24 2026-07-06
...
#> # i 7,684 more rows
#> # i 1 more variable: cntra_mp_id <chr>
```
...
#> # i 769 more rows
#> # i 11 more variables: exclude_financials <lgl>, exclude_utilities <lgl>,
