...
list_supported_datasets_ff_legacy <- function() {
  ...
  tribble(
    ...
    "factors_ff5_monthly"                 ,
    "Fama/French 5 Factors (2x3)"         ,
    "factors_ff_industry_5_monthly"       ,
    "5 Industry Portfolios"               ,
    "factors_ff_industry_5_daily"         ,
    "5 Industry Portfolios [Daily]"       ,
    "factors_ff_industry_10_monthly"      ,
    "10 Industry Portfolios"              ,
    "factors_ff_industry_10_daily"        ,
    "10 Industry Portfolios [Daily]"      ,
    "factors_ff_industry_30_monthly"      ,
    "30 Industry Portfolios"              ,
    "factors_ff_industry_30_daily"        ,
    "30 Industry Portfolios [Daily]"      ,
    "factors_ff_industry_38_monthly"      ,
    "38 Industry Portfolios"              ,
    "factors_ff_industry_38_daily"        ,
    "38 Industry Portfolios [Daily]"      ,
    "factors_ff_industry_48_monthly"      ,
    "48 Industry Portfolios"              ,
    "factors_ff_industry_48_daily"        ,
    "48 Industry Portfolios [Daily]"      ,
    "factors_ff_industry_49_monthly"      ,
    "49 Industry Portfolios"              ,
...
#' List Supported Synthetic WRDS Datasets
#'
#' Returns a tibble with the supported synthetic WRDS datasets generated by
...
list_supported_datasets_pseudo <- function() {
  ...
  tribble(
    ...
    ~dataset_name            ,
    "crsp_monthly"           ,
    "synthetic crsp_monthly" ,
    "crsp_daily"             ,
    "synthetic crsp_daily"   ,
    "compustat_annual"       ,
    "synthetic compustat_annual" ,
    "compustat_quarterly"    ,
    "synthetic compustat_quarterly" ,
    "ccm_links"              ,
    "synthetic ccm_links"
  ) |>
    dplyr::mutate(domain = "pseudo")
  # nolint end
}
