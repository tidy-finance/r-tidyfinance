...
test_that("estimate_fama_macbeth detail = FALSE returns flat data frame by default", {
  set.seed(123)
  data <- tibble(
    date = rep(
      seq.Date(
...
test_that("estimate_fama_macbeth detail = TRUE returns list with two data frames", {
  set.seed(123)
  data <- tibble(
    date = rep(
      seq.Date(
...
test_that("estimate_fama_macbeth detail = TRUE coefficients has correct structure", {
  set.seed(123)
  data <- tibble(
    date = rep(
      seq.Date(
...
test_that("estimate_fama_macbeth detail = TRUE summary_statistics has correct structure", {
  set.seed(42)
  data <- tibble(
    date = rep(
      seq.Date(
