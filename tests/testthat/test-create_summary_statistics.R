...
test_that("NA values are handled correctly", {
  ...
  expect_equal(result_drop_na$n, result_keep_na$n)
  expect_equal(result_keep_na$mean, as.double(NA))
  expect_equal(result_keep_na$sd, as.double(NA))
  expect_equal(result_keep_na$min, as.double(NA))
  expect_equal(result_keep_na$q50, as.double(NA))
  expect_equal(result_keep_na$max, as.double(NA))
})
